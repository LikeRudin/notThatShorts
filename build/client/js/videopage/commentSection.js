...
var deleteBtnArray = document.querySelectorAll(".comment__delete__btn");
var paintComment = function paintComment(text, id) {
  ...
  commentText.innerText = " ".concat(text);
...
if (deleteBtnArray) {
  deleteBtnArray.forEach(function (span) {
    return span.addEventListener("click", handleDelete);
  });
}