...
exports.startGithubLogin = exports.postLogin = exports.postJoin = exports.postEdit = exports.postChangePassword = exports.logout = exports.getProfile = exports.getLogin = exports.getJoin = exports.getEdit = exports.getChangePassword = exports.finishGithubLogin = void 0;
...
var postLogin = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var pageTitle, _req$body, username, password, user, ok;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          pageTitle = "Login";
          _req$body = req.body, username = _req$body.username, password = _req$body.password; //check username
          _context.next = 4;
...
var postJoin = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var pageTitle, _req$body2, name, username, email, location, password1, password2, exists;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          pageTitle = "Join";
          _req$body2 = req.body, name = _req$body2.name, username = _req$body2.username, email = _req$body2.email, location = _req$body2.location, password1 = _req$body2.password1, password2 = _req$body2.password2;
          if (!(password1 !== password2)) {
            _context2.next = 4;
            break;
          }
          return _context2.abrupt("return", res.status(400).render("join", {
            pageTitle: pageTitle,
...
var postEdit = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$session$user, _id, avatarUrl, sessionEmail, sessionUsername, file, _req$body3, name, email, username, location, searchParam, foundUser, updatedUser;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          console.log("postEdit is running");
          _req$session$user = req.session.user, _id = _req$session$user._id, avatarUrl = _req$session$user.avatarUrl, sessionEmail = _req$session$user.email, sessionUsername = _req$session$user.username, file = req.file;
          _req$body3 = req.body, name = _req$body3.name, email = _req$body3.email, username = _req$body3.username, location = _req$body3.location;
          console.log("".concat(name, ", ").concat(email, ", ").concat(username, ", ").concat(location));
          searchParam = [];
        ...
        case 10:
          ...
          return _context3.abrupt("return", res.status(400).render("edit-profile", {
            pageTitle: "Edit Profile",
        ...
        case 15:
          ...
          return _context3.abrupt("return", res.redirect("/users/edit"));
        case 19:
        case "end":
...
var postChangePassword = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _id, _req$body4, presentPassword, newPassword, newPassword2, user, ok;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _id = req.session.user, _req$body4 = req.body, presentPassword = _req$body4.presentPassword, newPassword = _req$body4.newPassword, newPassword2 = _req$body4.newPassword2;
          _context4.next = 3;
          return _User["default"].findById(_id);
        case 3:
          user = _context4.sent;
          _context4.next = 6;
          return _bcrypt["default"].compare(presentPassword, user.password);
        case 6:
          ok = _context4.sent;
          if (!ok) {
        ...
        case 12:
          ...
          return _context4.abrupt("return", res.redirect("/users/logout"));
        case 14:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 17:
          ...
          _context5.next = 20;
          return (0, _nodeFetch["default"])("".concat(apiUrl, "/emails"), {
            headers: {
              Authorization: "token ".concat(access_token)
            }
          });
...
var getProfile = /*#__PURE__*/function () {
  ...
  return function getProfile(_x11, _x12) {
